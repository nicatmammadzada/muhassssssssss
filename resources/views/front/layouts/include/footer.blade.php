<div class="footer index2_footer_wrapper footer_index3 shaa jb_cover">
    <div class="ft_shape bubble-18">
        <img src="/front/images/bubble2.png" class="img-responsive " alt="img">
    </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="footerNav jb_cover">
                    <a href="#"><img src="/front/images/logo5.png" alt="img"></a>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="footerNav jb_cover footer_border_displ">
                    ...
                    <ul class="nav-widget">
                        ...
                        <li>
                            <a href="#"><img src="/front/images/ft3.png" alt="img">Flexidocs
                            </a>
                        </li>
                        <li>
                            <a href="#"><img src="/front/images/ft4.png" alt="img">Microsoft Exchange</a>
                        </li>
                        <li>
                            <a href="#"><img src="/front/images/ft5.png" alt="img"> Mailchimp
                            </a>
                        </li>
                        <li>
                            <a href="#"><img src="/front/images/ft6.png" alt="img"> MYOB
                            </a>
                        </li>
