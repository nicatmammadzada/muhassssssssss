        ...
        <table class="table datatable-responsive-row-control">
            ...
            @if($category->products->count()>0)
                @foreach($category->products as $key=>$product)
                    ...
                    <td></td>
                         <td><input type='number' style='width:80px;' class='form-control' value="{{$product->row}}" onblur='changeRow(this.value,{{$product->id}})' </td>
                        <td>
                        ...
                        <td><a href="{{route('admin.product.edit',$product->id)}}">{{$product->kkal ?? ''}}</a>
                        </td>
