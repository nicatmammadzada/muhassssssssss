        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li><a href="{{route('admin.category.index')}}"><i class=" fa fa-th-list"></i>
...
{{--                    </li>--}}
                    ...
                    <li><a href="{{route('admin.cv.index')}}"><i class="fa fa-file-text"></i>
                            <span>Cv göndərənlər</span></a></li>

                    <li><a href="{{route('admin.client.index')}}"><i class="fa fa-first-order"></i>
                            <span>Clients</span></a></li>


                    <li><a href="{{route('admin.vacancies.index')}}"><i class="fa fa-first-order"></i>
                            <span>Vakansiyalar</span></a></li>

                    <li><a href="{{route('admin.about')}}"><i class="fa fa-first-order"></i>
                            <span>Haqqinda</span></a></li>

                    <li><a href="{{route('admin.delivery')}}"><i class="fa fa-first-order"></i>
                            <span>Catdirilma</span></a></li>
